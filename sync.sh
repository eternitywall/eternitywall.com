spectacle -t _site/api/pn2a/ -l img/logos/eternity_logo_final.svg api/pn2a/spec.yaml
spectacle -t _site/api/authcal/ -l img/logos/eternity_logo_final.svg api/authcal/spec.yaml
jekyll build
